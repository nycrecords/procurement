...
# 6. Create ssl Certs
openssl req \
       -newkey rsa:4096 -nodes -keyout /vagrant/build_scripts/web_setup/procurement.key \
       -x509 -days 365 -out /vagrant/build_scripts/web_setup/procurement.crt -subj "/C=US/ST=New York/L=New York/O=NYC Department of Records and Information Services/OU=IT/CN=procurement.nyc"
openssl x509 -in /vagrant/build_scripts/web_setup/procurement.crt -out /vagrant/build_scripts/web_setup/procurement.pem -outform PEM
