...
sudo -u postgres /opt/rh/rh-postgresql95/root/usr/bin/createuser -s -e procurement_db

# 12. Create database
sudo -u postgres /opt/rh/rh-postgresql95/root/usr/bin/createdb procurement
